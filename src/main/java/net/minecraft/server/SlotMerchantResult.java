...
public class SlotMerchantResult extends Slot {
    ...
    public void a(EntityHuman entityhuman, ItemStack itemstack) {
        ...
        // CraftBukkit - throw the completed event.
        org.bukkit.craftbukkit.event.CraftEventFactory.callMerchantTradeCompleteEvent(merchantrecipe, d, itemstack, b.activeContainer.getBukkitView());
