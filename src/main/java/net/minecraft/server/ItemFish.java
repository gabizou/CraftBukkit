...
public class ItemFish extends ItemFood {
    ...
    protected void c(ItemStack itemstack, World world, EntityHuman entityhuman) {
        ...
        if (enumfish == EnumFish.PUFFERFISH) {
            // CraftBukkit start - Added 'EntityPotionEffectChangeEvent.Cause.FOOD'
        ...
        //super.c(itemstack, world, entityhuman); CraftBukkit - Causes the client to add effects even if events are cancelled
    }
